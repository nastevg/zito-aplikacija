...
const I18N: Record<LanguageCode, Record<string, string>> = {
  mk: {
    ...
    tab_profile: "Профил",
    tab_more: "Повеќе",
    screen_flyers_title: "Детална анализа",
    screen_flyers_subtitle: "Детален преглед на купувања и категории",
  ...
  en: {
    ...
    tab_profile: "Profile",
    tab_more: "More",
    screen_flyers_title: "Detailed Analysis",
    screen_flyers_subtitle: "Detailed shopping and category overview",
  ...
  sq: {
    ...
    tab_profile: "Profili",
    tab_more: "More",
    screen_flyers_title: "Analize e Detajuar",
    screen_flyers_subtitle: "Pasqyre e detajuar e blerjeve dhe kategorive",
  ...
  tr: {
    ...
    tab_profile: "Profil",
    tab_more: "More",
    screen_flyers_title: "Detayli Analiz",
    screen_flyers_subtitle: "Alisveris ve kategoriler icin detayli ozet",
